...
(function () {
  ...
  const T = {
    ...
    en: {
      ...
      'intro.room-body':'When the dive is done, your air-conditioned room is steps away — garden views, a wet-room shower, and Sensatia Botanical toiletries waiting for you. Double and twin options available.',
      ...
      'pr3.cat':'Certified divers','pr3.title':'Guided Dive','pr3.r1':'One dive','pr3.r2':'Two dives','pr3.r3':'Three dives','pr3.r4':'Night dive','pr3.r5':'Five dives (Tulamben/Kubu)','pr3.btn':'Learn More →',
      ...
      'stay.label':'Stay & Dive','stay.heading':'Dive.<br>Rest.<br>Repeat.','stay.body':'Your room is steps from the beach. Wake up, gear up, and you\'re in the water within minutes. After the dive, rinse off and recharge in a calm, comfortable space built for people who take their diving seriously.','stay.f1.title':'Air-Conditioned','stay.f1.sub':'Double & twin rooms, garden views','stay.f2.title':'Wet-Room Shower','stay.f2.sub':'Polished concrete, open & airy','stay.f3.title':'Sensatia Botanicals','stay.f3.sub':'Premium Balinese toiletries','stay.f4.title':'2 Min to the Beach','stay.f4.sub':'Walk out, gear up, dive in','stay.cta':'View Room Tour',
      ...
      'faq.a9':'We accept multiple payment methods for your convenience: <strong>Credit &amp; debit cards</strong> (Visa, Mastercard), <strong>Wise</strong> (international transfer — ideal for overseas guests), and <strong>direct bank transfer</strong>. Payment is made on arrival at the dive centre — no deposit required. If you prefer to pay in advance via Wise or bank transfer, just let us know on WhatsApp and we will send you the details.',
    ...
    zh: {
      ...
      'intro.room-body':'潜水结束后，空调客房近在咫尺——花园景观、湿式淋浴间，以及 Sensatia 植物系洗护品静待您的归来。提供双人床及双床房可选。',
      ...
      'pr3.cat':'持证潜水员','pr3.title':'导潜服务','pr3.r1':'一次潜水','pr3.r2':'两次潜水','pr3.r3':'三次潜水','pr3.r4':'夜潜','pr3.r5':'五次潜水（图兰奔/库布）','pr3.btn':'了解更多 →',
      ...
      'stay.label':'住宿 & 潜水','stay.heading':'潜水。<br>休息。<br>再来一次。','stay.body':'您的房间距海滩仅几步之遥。起床、装备就绪，几分钟内即可入水。潜水结束后，冲洗一番，在这个专为认真对待潜水的人打造的宁静舒适空间里恢复精力。','stay.f1.title':'空调客房','stay.f1.sub':'双人床及双床房，花园景观','stay.f2.title':'湿式淋浴间','stay.f2.sub':'抛光混凝土，开放宽敞','stay.f3.title':'Sensatia 植物系','stay.f3.sub':'巴厘岛高端洗护品','stay.f4.title':'距海滩仅2分钟','stay.f4.sub':'出门、装备、入水','stay.cta':'查看房间实拍',
      ...
      'faq.q9':'你们接受哪些付款方式？',
      'faq.a9':'我们提供多种便捷的付款方式：<strong>信用卡/借记卡</strong>（Visa、Mastercard）、<strong>Wise</strong>（国际转账，非常适合海外客人）以及<strong>银行直接转账</strong>。无需预付定金，付款在到达潜水中心时进行。如需提前通过 Wise 或银行转账付款，请在 WhatsApp 中告知我们，我们将发送付款详情。',
    ...
    de: {
      ...
      'intro.room-body':'Nach dem Tauchgang ist dein klimatisiertes Zimmer nur wenige Schritte entfernt — Gartenblick, eine Nasszelle und Sensatia Botanical Toilettenartikel erwarten dich. Doppel- und Zweibettzimmer verfügbar.',
      ...
      'pr3.cat':'Zertifizierte Taucher','pr3.title':'Geführter Tauchgang','pr3.r1':'Ein Tauchgang','pr3.r2':'Zwei Tauchgänge','pr3.r3':'Drei Tauchgänge','pr3.r4':'Nachttauchgang','pr3.r5':'Fünf Tauchgänge (Tulamben/Kubu)','pr3.btn':'Mehr erfahren →',
      ...
      'stay.label':'Übernachten & Tauchen','stay.heading':'Tauchen.<br>Erholen.<br>Wiederholen.','stay.body':'Dein Zimmer liegt nur wenige Schritte vom Strand entfernt. Aufstehen, Ausrüstung anlegen und schon bist du innerhalb von Minuten im Wasser. Nach dem Tauchgang abspülen und in einem ruhigen, komfortablen Raum neue Kräfte sammeln.','stay.f1.title':'Klimatisiert','stay.f1.sub':'Doppel- & Zweibettzimmer, Gartenblick','stay.f2.title':'Nasszelle','stay.f2.sub':'Polierter Beton, offen & luftig','stay.f3.title':'Sensatia Botanicals','stay.f3.sub':'Premium Balinese Toilettenartikel','stay.f4.title':'2 Min zum Strand','stay.f4.sub':'Rausgehen, ausrüsten, tauchen','stay.cta':'Zimmer ansehen',
      ...
      'faq.q9':'Welche Zahlungsmethoden werden akzeptiert?',
      'faq.a9':'Wir akzeptieren mehrere Zahlungsmethoden: <strong>Kredit- &amp; Debitkarten</strong> (Visa, Mastercard), <strong>Wise</strong> (internationaler Geldtransfer — ideal für ausländische Gäste) und <strong>direkte Banküberweisung</strong>. Die Zahlung erfolgt bei Ankunft im Tauchzentrum — keine Anzahlung erforderlich. Wer lieber im Voraus zahlt, kann uns einfach per WhatsApp kontaktieren.',
    ...
    ru: {
      ...
      'intro.room-body':'После погружения вас ждёт номер с кондиционером в нескольких шагах — вид на сад, душевая комната и премиальная косметика Sensatia Botanical. Доступны двухместные номера и номера с двумя отдельными кроватями.',
      ...
      'pr3.cat':'Для сертифицированных','pr3.title':'С гидом','pr3.r1':'Одно погружение','pr3.r2':'Два погружения','pr3.r3':'Три погружения','pr3.r4':'Ночное погружение','pr3.r5':'Пять погружений (Туламбен/Кубу)','pr3.btn':'Подробнее →',
      ...
      'stay.label':'Проживание & Дайвинг','stay.heading':'Погружение.<br>Отдых.<br>Снова.','stay.body':'Ваш номер находится в нескольких шагах от пляжа. Просыпайтесь, надевайте снаряжение и оказывайтесь в воде уже через несколько минут. После погружения смойте усталость и восстановите силы в спокойном уютном пространстве.','stay.f1.title':'Кондиционер','stay.f1.sub':'Двухместные номера, вид на сад','stay.f2.title':'Душевая комната','stay.f2.sub':'Полированный бетон, открытая','stay.f3.title':'Sensatia Botanicals','stay.f3.sub':'Премиальная балийская косметика','stay.f4.title':'2 мин до пляжа','stay.f4.sub':'Выйти, собраться, нырнуть','stay.cta':'Посмотреть номера',
      ...
      'faq.q9':'Какие способы оплаты вы принимаете?',
      'faq.a9':'Мы принимаем несколько способов оплаты: <strong>кредитные и дебетовые карты</strong> (Visa, Mastercard), <strong>Wise</strong> (международный перевод — идеально для иностранных гостей) и <strong>прямой банковский перевод</strong>. Оплата производится по прибытии в дайв-центр — депозит не требуется. Если хотите оплатить заранее через Wise или банковский перевод, просто напишите нам в WhatsApp.',
    ...
    ja: {
      ...
      'intro.room-body':'ダイビングが終わったら、エアコン完備のお部屋はすぐそこ、花園の景色、ウェットルームシャワー、Sensatia Botanicalのアメニティがお待ちしています。ダブル・ツインルームご用意。',
      ...
      'pr3.cat':'認定ダイバー向け','pr3.title':'ガイドダイブ','pr3.r1':'1ダイブ','pr3.r2':'2ダイブ','pr3.r3':'3ダイブ','pr3.r4':'ナイトダイブ','pr3.r5':'5ダイブ（トランベン/クブ）','pr3.btn':'詳しく見る →',
      ...
      'stay.label':'宿泊 & ダイビング','stay.heading':'潜る。<br>休む。<br>また潜る。','stay.body':'お部屋はビーチから数歩の距離。起きて、機材を準備して、数分以内に水中へ。ダイビング後は真水でさっぱりして、ダイビングを本気で楽しむ人のために作られた静かで快適な空間でリチャージ。','stay.f1.title':'エアコン完備','stay.f1.sub':'ダブル・ツインルーム、ガーデンビュー','stay.f2.title':'ウェットルームシャワー','stay.f2.sub':'磨きコンクリート、開放的','stay.f3.title':'Sensatia Botanicals','stay.f3.sub':'バリ島プレミアムアメニティ','stay.f4.title':'ビーチまで徒歩2分','stay.f4.sub':'出発、準備、入水','stay.cta':'ルームツアーを見る',
      ...
      'faq.q9':'どのような支払い方法が使えますか？',
      'faq.a9':'複数の支払い方法をご用意しています：<strong>クレジット・デビットカード</strong>（Visa、Mastercard）、<strong>Wise</strong>（海外送金 — 海外からのゲストに最適）、<strong>銀行振込</strong>。お支払いはダイブセンター到着時に行います。デポジット不要です。事前にWiseや銀行振込でお支払いご希望の場合はWhatsAppでお知らせください。',
    ...
    ko: {
      ...
      'intro.room-body':'다이빙이 끝나면 에어콘 완비 객실이 바로 얕에 — 정원 뷰, 웨실 샴워, Sensatia Botanical 어메니티가 기다리고 있습니다. 더블 및 트윈 룸을 이용하실 수 있습니다.',
      ...
      'pr3.cat':'자격증 보유 다이버','pr3.title':'가이드 다이빙','pr3.r1':'1회 다이빙','pr3.r2':'2회 다이빙','pr3.r3':'3회 다이빙','pr3.r4':'야간 다이빙','pr3.r5':'5회 다이빙 (툴람벤/쿠부)','pr3.btn':'자세히 보기 →',
      ...
      'stay.label':'숙박 & 다이빙','stay.heading':'다이빙.<br>휴식.<br>다시 반복.','stay.body':'객실은 해변에서 불과 몇 걸음 거리입니다. 일어나서 장비를 챙기면 몇 분 안에 물속으로 들어갈 수 있습니다. 다이빙 후에는 깔끔하게 씻고 진지하게 다이빙을 즐기는 사람들을 위해 만들어진 조용하고 편안한 공간에서 재충전하세요.','stay.f1.title':'에어컨 완비','stay.f1.sub':'더블 & 트윈룸, 정원 뷰','stay.f2.title':'웻룸 샤워','stay.f2.sub':'폴리시드 콘크리트, 개방감 있는','stay.f3.title':'Sensatia Botanicals','stay.f3.sub':'발리 프리미엄 어메니티','stay.f4.title':'해변까지 2분','stay.f4.sub':'나가서, 준비하고, 입수','stay.cta':'객실 투어 보기',
      ...
      'faq.q9':'어떤 결제 방법을 사용할 수 있나요？',
      'faq.a9':'다양한 결제 방법을 지원합니다: <strong>신용·체크카드</strong> (Visa, Mastercard), <strong>Wise</strong> (해외 송금 — 해외 고객에게 최적), <strong>계좌 이체</strong>. 결제는 다이브 센터 도착 시 이루어지며 보증금은 필요하지 않습니다. Wise 또는 계좌 이체로 미리 결제를 원하시면 WhatsApp으로 알려주세요.',
    ...
    fr: {
      ...
      'intro.room-body':'Après la plongée, votre chambre climatisée est à quelques pas — vue jardin, douche wet-room et produits Sensatia Botanical vous attendent. Chambres double et twin disponibles.',
      ...
      'pr3.cat':'Plongeurs certifiés','pr3.title':'Plongée guidée','pr3.r1':'Une plongée','pr3.r2':'Deux plongées','pr3.r3':'Trois plongées','pr3.r4':'Plongée nocturne','pr3.r5':'Cinq plongées (Tulamben/Kubu)','pr3.btn':'En savoir plus →',
      ...
      'stay.label':'Séjour & Plongée','stay.heading':'Plonger.<br>Se reposer.<br>Recommencer.','stay.body':'Votre chambre est à quelques pas de la plage. Réveillez-vous, équipez-vous et vous êtes dans l\'eau en quelques minutes. Après la plongée, rincez-vous et rechargez les batteries dans un espace calme et confortable conçu pour ceux qui prennent leur plongée au sérieux.','stay.f1.title':'Climatisation','stay.f1.sub':'Chambres double & twin, vue jardin','stay.f2.title':'Douche wet-room','stay.f2.sub':'Béton poli, espace ouvert','stay.f3.title':'Sensatia Botanicals','stay.f3.sub':'Produits balais premium','stay.f4.title':'2 min de la plage','stay.f4.sub':'Sortir, s\'équiper, plonger','stay.cta':'Voir les chambres',
      ...
      'faq.q9':'Quels moyens de paiement acceptez-vous ?',
      'faq.a9':'Nous acceptons plusieurs moyens de paiement : <strong>Carte de crédit &amp; débit</strong> (Visa, Mastercard), <strong>Wise</strong> (virement international — idéal pour les clients étrangers) et <strong>virement bancaire direct</strong>. Le paiement s\'effectue à l\'arrivée au centre de plongée — aucun acompte requis. Si vous préférez payer à l\'avance via Wise ou virement, contactez-nous sur WhatsApp.',
  ...
  const MAP = [
    ...
    ['#intro .intro-room-body','intro.room-body'],
    ...
    // Stay section
    ['#stay .stay-label','stay.label'],
    ['#stay .stay-heading','stay.heading'],
    ['#stay .stay-body','stay.body'],
    ['#stay .stay-f1-title','stay.f1.title'],
    ['#stay .stay-f1-sub','stay.f1.sub'],
    ['#stay .stay-f2-title','stay.f2.title'],
    ['#stay .stay-f2-sub','stay.f2.sub'],
    ['#stay .stay-f3-title','stay.f3.title'],
    ['#stay .stay-f3-sub','stay.f3.sub'],
    ['#stay .stay-f4-title','stay.f4.title'],
    ['#stay .stay-f4-sub','stay.f4.sub'],
    ['#stay .stay-cta-text','stay.cta'],
    ...
    ['.pricing-grid .pricing-card:nth-child(2) .pricing-row:nth-child(4) .pricing-name','pr2.r1'],
    ['.pricing-grid .pricing-card:nth-child(2) .pricing-row:nth-child(5) .pricing-name','pr2.r2'],
    ...
    ['.pricing-grid .pricing-card:nth-child(3) .pricing-row:nth-child(4) .pricing-name','pr3.r1'],
    ['.pricing-grid .pricing-card:nth-child(3) .pricing-row:nth-child(5) .pricing-name','pr3.r2'],
    ['.pricing-grid .pricing-card:nth-child(3) .pricing-row:nth-child(6) .pricing-name','pr3.r3'],
    ['.pricing-grid .pricing-card:nth-child(3) .pricing-row:nth-child(7) .pricing-name','pr3.r5'],
    ['.pricing-grid .pricing-card:nth-child(3) .pricing-row:nth-child(8) .pricing-name','pr3.r4'],
