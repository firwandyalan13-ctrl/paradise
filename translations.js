...
(function () {
  ...
  const T = {
    ...
    en: {
      ...
      'pr3.cat':'Certified divers','pr3.title':'Guided Dive','pr3.r1':'Private guide / per day','pr3.r2':'One dive','pr3.r3':'Night dive','pr3.r4':'Boat dive (jukung) / max 2 pax per boat','pr3.btn':'Learn More →',
    ...
    zh: {
      ...
      'pr3.cat':'持证潜水员','pr3.title':'导潜服务','pr3.r1':'私人向导 / 每天','pr3.r2':'一次潜水','pr3.r3':'夜潜','pr3.r4':'船潜（jukung）/ 每船最多2人','pr3.btn':'了解更多 →',
    ...
    de: {
      ...
      'pr3.cat':'Zertifizierte Taucher','pr3.title':'Geführter Tauchgang','pr3.r1':'Privater Guide / pro Tag','pr3.r2':'Ein Tauchgang','pr3.r3':'Nachttauchgang','pr3.r4':'Bootstauchgang (Jukung) / max. 2 Personen pro Boot','pr3.btn':'Mehr erfahren →',
    ...
    ru: {
      ...
      'pr3.cat':'Для сертифицированных','pr3.title':'С гидом','pr3.r1':'Личный гид / день','pr3.r2':'Одно погружение','pr3.r3':'Ночное погружение','pr3.r4':'Лодочное погружение (джукунг) / макс. 2 чел. на лодку','pr3.btn':'Подробнее →',
    ...
    ja: {
      ...
      'pr3.cat':'認定ダイバー向け','pr3.title':'ガイドダイブ','pr3.r1':'プライベートガイド / 1日','pr3.r2':'1ダイブ','pr3.r3':'ナイトダイブ','pr3.r4':'ボートダイブ（ジュクン）/ 1艇最大2名','pr3.btn':'詳しく見る →',
    ...
    ko: {
      ...
      'pr3.cat':'자격증 보유 다이버','pr3.title':'가이드 다이빙','pr3.r1':'프라이빗 가이드 / 1일','pr3.r2':'1회 다이빙','pr3.r3':'야간 다이빙','pr3.r4':'보트 다이빙 (주쿵) / 보트당 최대 2명','pr3.btn':'자세히 보기 →',
    ...
    fr: {
      ...
      'pr3.cat':'Plongeurs certifiés','pr3.title':'Plongée guidée','pr3.r1':'Guide privé / par jour','pr3.r2':'Une plongée','pr3.r3':'Plongée nocturne','pr3.r4':'Plongée bateau (jukung) / max 2 pers. par bateau','pr3.btn':'En savoir plus →',
  ...
  const MAP = [
    ...
    ['.pricing-grid .pricing-card:nth-child(3) .pricing-row:nth-child(7) .pricing-name','pr3.r4'],
